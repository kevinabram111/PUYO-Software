...
namespace PUYO
{
    public partial class POS : Form
    {
        ...
        {
            string TotalValue = Convert.ToString(sum);

            string TotalValueTax = Convert.ToString(sum * 10 / 100);

            string GrandTotalValue = Convert.ToString(Convert.ToDouble(TotalValue) + Convert.ToInt32(TotalValueTax));

            Total_Label.Text = "RP " + TotalValue;

            Tax_Label.Text = "RP " + TotalValueTax;

            Grand_Total_Label.Text = "RP " + GrandTotalValue;
        }
        ...
        {
            PUYO_FUNCTION.SUBMIT_TRANSACTION(PUYO_FUNCTION.GET_MASTER_TRANSACTION_ID(), "SOLD");
